...
BOOST_AUTO_TEST_CASE ( constructor ) {
    ...
    BOOST_CHECK_THROW(numopt::eigenproblem::DavidsonSolver (A, solver_options_faulty), std::invalid_argument);  // 3 requested eigenpairs: not enough initial guesses
...
BOOST_AUTO_TEST_CASE ( diagonal_getter_Davidson ) {
    ...
    numopt::eigenproblem::DavidsonSolver davidson_solver (A, numopt::eigenproblem::DavidsonSolverOptions (x_0));
...
BOOST_AUTO_TEST_CASE ( liu_50_collapse ) {
    ...
    numopt::eigenproblem::DavidsonSolver davidson_solver (A, solver_options);  // maximum subspace dimension = 10, collapsed subspace dimension = 5
    davidson_solver.solve();
