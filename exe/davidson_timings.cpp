/**
 *  Do some timings concerning the Davidson diagonalization method.
 */
...
void solveEigenvalueProblemWithDavidson(const Eigen::MatrixXd& A) {
    ...
    numopt::eigenproblem::DavidsonSolver davidson_solver (A, numopt::eigenproblem::DavidsonSolverOptions (t_0));
